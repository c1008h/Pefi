...
export const CREATE_NETWORTH = gql`
  mutation createNetworth($id: ID, $year: Float, $digital: Float, $cash: Float, $invested: Float, $saved: Float, $networth: Float, $totalIncome: Float, $totalExpense: Float) {
    createNetworth(id: $id, year: $year, digital: $digital, cash: $cash, invested: $invested, saved: $saved, networth: $networth, totalIncome: $totalIncome, totalExpense: $totalExpense) {
      networthGroup {
        id
        year
        digital
